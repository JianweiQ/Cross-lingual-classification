...
#     countUniqueWordsbarplot(X_e_count, X_c_count, "Unique words count before pre-processing")
#     
#     # data pre-processing
#     
...
#     X_e_count = countUniqueWords(X_e, y_e, 4)
#     X_c_count = countUniqueWords(X_c, y_c, 4)
#     countUniqueWordsbarplot(X_e_count, X_c_count, "Unique words count after pre-processing")
